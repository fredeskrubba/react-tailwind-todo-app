    ...
    return (
        <div className="fixed inset-y-0 right-0 w-[320px] bg-white border-l border-main-green p-6 overflow-y-auto shadow-lg z-50 md:flex-col md:justify-between hidden md:flex">
                        <div className='flex flex-col gap-4 h-full'>
                            ...
                            <textarea className="w-full h-full text-base text-gray-900 bg-transparent border-0 focus:outline-none focus:ring-0 resize-none" value={activeDescription} onChange={(e) => setActiveDescription(e.target.value)} placeholder='Enter description'/>
